...
namespace Zapdate.Core.Domain
{
    ...
    public sealed class SemVersion : IComparable<SemVersion>, IComparable
    {
        ...
        public SemVersion(Version version)
        {
            ...
            Build = version.Build > 0 ? version.Build.ToString() : null;
        }
        ...
        public static SemVersion Parse(string version, bool strict = false)
        {
            ...
            return new SemVersion(major, minor, patch, string.IsNullOrEmpty(prerelease) ? null : prerelease, 
                string.IsNullOrEmpty(build) ? null : build);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                result = result * 31 + (Prerelease?.GetHashCode() ?? 0);
                result = result * 31 + (Build?.GetHashCode() ?? 0);
                return result;
            }
        }
